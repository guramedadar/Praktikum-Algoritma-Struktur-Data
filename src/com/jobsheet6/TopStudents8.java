...
public class TopStudents8 
{
    Student8[] listStudents;
    int idx;
    
    public void add (Student8 student)
    {
    ...
    public void selectionSort()
    {
        for (int i = 0; i < idx - 1; i++) 
        {
            ...
            Student8 temp = listStudents[minIndex];
